    ...
    <footer className="bg-slate-50 border-t border-slate-200 mt-16">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 py-10">
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-3">
              ...
              <div>
                <div className="font-black text-lg text-slate-900">ChemistShop</div>
                <div className="text-[11px] text-teal-700 font-semibold tracking-wide">APKA APNA CHEMIST</div>
              </div>
            </Link>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-6 border-t border-slate-200">
          <p className="text-xs text-slate-500">© {new Date().getFullYear()} ChemistShop. All rights reserved. Apka Apna Chemist – Trusted Care Near You.</p>
