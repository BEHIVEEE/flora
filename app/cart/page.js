        ...
        <div className="grid lg:grid-cols-[1fr_360px] gap-6 mt-6">
              ...
              <div key={i.id} className="bg-white rounded-2xl border border-slate-200 p-4 flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="inline-flex items-center border border-slate-300 rounded-full">
          ...
          <aside className="lg:sticky lg:top-32 self-start">
            <div className="bg-white rounded-2xl border border-slate-200 p-5">
              ...
              {deliveryFee > 0 && (
                <div className="mt-3 text-xs bg-amber-50 text-amber-800 p-2 rounded-lg">Add ₹{499 - subtotal} more to get FREE delivery!</div>
              )}
